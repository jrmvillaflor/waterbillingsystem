...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('assets/css/jrmvstyle.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/css/free.min.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/css/brand.min.css');?>">
        <link rel="stylesheet" href="<?php echo base_url('assets/css/flag.min.css');?>">
