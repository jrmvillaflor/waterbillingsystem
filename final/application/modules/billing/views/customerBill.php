...
<body>
    ...
    <table class="table table-stripe table-bordered">
        ...
        <tbody id="tableaccounts">
            <tr>
                <td colspan="4" class="label-bill"><?php echo $userInfo[0]->first_name." ". $userInfo[0]->last_name?></td>
            </tr>
            <tr>
                <td colspan="4" class="label-bill"><?php echo $userInfo[0]->customer_account_id?>
            ...
            <tr>
                ...
                <td class="text-gray"><?php echo $total = $bill + round($arrears + $arrears * $OP[0]->op_value,2)?></td>
            </tr>
            <tr>
                <td colspan="4"></td>
            </tr>
